...
for(const entry of ['background','content','ui','favstash-handoff'])await build({entryPoints:[`src/${entry}.ts`],bundle:true,outfile:`dist/${entry}.js`,format:['content','favstash-handoff'].includes(entry)?'iife':'esm',target:'chrome120',minify:true,sourcemap:false});
